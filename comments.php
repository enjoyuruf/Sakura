			...
			<?php
				...
				if(comments_open()){
					...
					$args = array(
						...
						'comment_field' => '<p><i class="iconfont icon-markdown"></i> Markdown and <i class="fa fa-code" aria-hidden="true"></i> are all Forbidden</p><div class="comment-textarea"><textarea placeholder="' . __("You are a surprise that I will only meet once in my life", "sakura") . ' ..." name="comment" class="commentbody" id="comment" rows="5" tabindex="4"></textarea><label class="input-label">' . __("You are a surprise that I will only meet once in my life", "sakura") . ' ...</label></div>
